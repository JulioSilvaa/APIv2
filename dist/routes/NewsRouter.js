...
router.patch("/:id", AuthMiddleware_1.default.auth, NewController_1.default.update);
router.delete("/:id", AuthMiddleware_1.default.auth, NewController_1.default.delete);
router.post("/", multer_1.default.array("file", LIMIT_IMAGE), AuthMiddleware_1.default.auth, NewController_1.default.store);
